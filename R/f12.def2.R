...
f12.def2 = function(alpha=0.025, beta=0.01, delta=0.005, sigma=0.013, u=c(1,1,1,1), b=0.005/4, set.pow=0.8) 
{
  ...
  con.pow=function(x, a)	 # x=f[1] a=c(s, u, b, delta, sigma, N, z.alpha)
  {
    s = a[1]
    u = a[2:(s+1)]
    b = a[s+2]
