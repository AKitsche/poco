...
f11.def2 = function(alpha=0.025, beta=0.01, delta=0.005, sigma=0.013, u=c(1,1,1,1), b=0.005/4, set.pow=0.8) 

{
  ...
  f1.un = uniroot(un.pow, c(0.01, 1/s), tol=0.0001, a=c(s, u, b, delta, sigma, N, set.pow))[1]
